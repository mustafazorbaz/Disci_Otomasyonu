  ...
  <div id="content">
    ...
    include"../baglantiDB.php";
      ...
      if(@$_POST["kaydet"])
      {
        ...
        $id="1";
        $sorgu=mysql_query("UPDATE  kayanyazi SET id='$id',icerik='$icerik'  WHERE id='$id'");
        if (!$sorgu) {
    	...
    	?>
           <form name="form1" method="post" action="<?php echo "kayanyazi.php";?>">
          <p>
          ...
          <p>
            <textarea name="icerik" id="icerik" cols="130" rows="20"><?php
             include"../baglantiDB.php"; 
                $sorgu=mysql_query("SELECT icerik FROM kayanyazi WHERE id='1'");
